...
(custom-set-variables
 ...
 '(package-selected-packages
   '(amx cargo clang-format cmake-mode company-box company-flx
		 counsel-projectile dashboard doom-themes embark
		 exec-path-from-shell flycheck-clang-tidy helpful
